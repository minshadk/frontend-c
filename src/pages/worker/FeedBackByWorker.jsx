...
const FeedBackByWorker = () => {
  ...
  useEffect(() => {
    ...
    const fetchAllFeedbacks = async () => {
      try {
        const response = await axios.get(`http://localhost:8001/feedback/byworker/${user.userId}`);
          ...
          {filteredFeedbacks.map((feedback) => (
            ...
            >
              ...
              <div className="mt-2">
                ...
                <span className="text-blue-600">{feedback.satisfactionLevel}</span>
              </div>
...
export default FeedBackByWorker;
